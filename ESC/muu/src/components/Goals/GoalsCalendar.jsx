...
function GoalsCalendar({ userType = 'aluno', equipeUsuario = 'Equipe Alpha' }) {
  ...
  // Dados de exemplo de metas
  const metasExemplo = [
    {
      id: 1,
      titulo: 'Arrecadar 50kg de alimentos',
      descricao: 'Meta semanal de arrecadação de alimentos não perecíveis',
    ...
    },
    {
      ...
      descricao: 'Organizar workshop sobre desenvolvimento de liderança empática',
    ...
    },
    {
      ...
      descricao: 'Elaborar relatório mensal de atividades da equipe',
